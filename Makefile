...
LIBS = ./lib/liblapack.lib ./lib/libblas.lib
COMPILER = gfortran
...
install:
	cp ./build/cactus.exe C:\MinGW\msys\1.0\bin
	cp ./lib/liblapack.dll C:\MinGW\msys\1.0\bin
	cp ./lib/libblas.dll C:\MinGW\msys\1.0\bin
	
uninstall:
	rm -f C:\MinGW\msys\1.0\bin\cactus.exe
	rm -f C:\MinGW\msys\1.0\bin\liblapack.dll
	rm -f C:\MinGW\msys\1.0\bin\libblas.dll
